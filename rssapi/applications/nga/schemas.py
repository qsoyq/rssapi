...
class NGASmile(BaseModel):
    ...
    url: str = Field(
        ..., description="表情对应的图片链接", examples=["https://img4.nga.cn/ngabbs/post/smile/ac15.png"]
    )
    tag: str = Field(
        ..., description="html a标签", examples=["""<img src="https://img4.nga.cn/ngabbs/post/smile/ac15.png">"""]
    )

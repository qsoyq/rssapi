...
@pytest.fixture
def middleware():
    return ExtractHashtagMiddleware(app=None)


class TestExtractHashtags:
    def test_extract_from_content_text(self, middleware):
    ...
    def test_fallback_to_content_html(self, middleware):
        item = _make_item(content_html="<p>check #design trends</p>")
        result = middleware.extract_hashtags(item)
        assert "#design" in result["tags"]

    def test_content_text_preferred_over_html(self, middleware):
        item = _make_item(
